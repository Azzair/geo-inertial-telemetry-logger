...
export function convertToCSV(records: any[], comment?: string): string {
  ...
  for (const r of records) {
    ...
    const row = [
      ...
      r.humidity !== null && r.humidity !== undefined ? r.humidity.toFixed(2) : "",
      r.windSpeed !== null && r.windSpeed !== undefined ? r.windSpeed.toFixed(2) : "",
      r.windDir !== null && r.windDir !== undefined ? r.windDir.toFixed(2) : "",
      r.calcSpeedIMU.toFixed(4),
      r.calcDistIMU.toFixed(2),
